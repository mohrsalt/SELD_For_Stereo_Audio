...
from mff_module import mff_module
...
class SELDModel(nn.Module):
    ...
    def __init__(self, params):
        ...
        self.params = params
        # Conv layers
        self.mff_module = mff_module(3, 6)
    ...
    def forward(self, audio_feat, vid_feat=None):
        ...
        audio_feat=self.conv_blocks[0](audio_feat)  # B x 64 x 50 x 2
        audio_feat= self.mff_module(audio_feat)  # B x 64 x 50 x 2  
